...
<div class="card uper">
    <h5 class="card-header info-color white-text text-center py-4">
        <strong>REGISTRAR FUNCIONARIO</strong>
    </h5>
    <div class="card-body px-lg-5 pt-0">
        ...
        @endif
        <form class="text-center" style="color: #757575;" method="post" action="{{ route('funcionario.store') }} " enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-row">
                <div class="col">
                    <div class="md-form">
                        @csrf
                        <input type="text" id="materialRegistrarUbicacion" class="form-control" name="nombrecompleto">
